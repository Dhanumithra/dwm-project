...
function MachineAvatar({ name }) {
  ...
  const isActive = true; // avatar always blue; status handled by pill
  return (
    <div style={{
...
export default function OperatorMachines({ machines = [] }) {
            ...
            {machines.map((m) => (
              <div className="col-lg-3 col-md-4 col-sm-6" key={m.id}>
                ...
                >
                  ...
                  <h5 style={{ fontWeight: 700, color: "#0f172a", fontSize: 14, marginBottom: 6, lineHeight: 1.3 }}>
                    {m.name}
                  </h5>
